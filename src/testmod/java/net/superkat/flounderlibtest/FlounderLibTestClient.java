...
import net.superkat.flounderlibtest.test.client.SimpleSyncedMinigameRenderer;
...
public class FlounderLibTestClient implements ClientModInitializer {
    ...
    public static final Identifier SIMPLE_SYNCED_MINIGAME_LAYER = Identifier.of(FlounderLibTest.MOD_ID, "simple_synced_minigame_layer");
    ...
    public void onInitializeClient() {
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.BOSS_BAR, SIMPLE_SYNCED_MINIGAME_LAYER, SimpleSyncedMinigameRenderer::render);
    }
}
