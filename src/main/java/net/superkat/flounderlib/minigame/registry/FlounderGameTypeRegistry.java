package net.superkat.flounderlib.minigame.registry;
...
public class FlounderGameTypeRegistry {
    ...
    public static <T extends IFlounderGame> FlounderGameType<T> register(FlounderGameType<T> type) {
