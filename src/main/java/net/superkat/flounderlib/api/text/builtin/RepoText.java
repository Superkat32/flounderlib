...
public class RepoText extends FlounderText {
    ...
    public RepoText(FlounderTextParams.Default params) {
        super(params);
...
//    public static final record RepoTextParams(Text text, boolean test) implements FlounderTextParams {
//        public static final Codec<RepoTextParams> CODEC = RecordCodecBuilder.create(
//                instance -> instance.group(
//                        TextCodecs.CODEC.fieldOf("text").forGetter(RepoTextParams::text),
//                        Codec.BOOL.fieldOf("test").forGetter(RepoTextParams::test)
//                ).apply(instance, RepoTextParams::new)
//        );
//
//        @Override
//        public Text getText() {
...
//    }
//
//    public static class RepoTextRenderer extends FlounderTextRenderer {
//        public RepoText currentText = null;
//
//        @Override
//        public void addText(FlounderText repoText) {
