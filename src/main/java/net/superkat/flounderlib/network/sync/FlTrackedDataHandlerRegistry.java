...
public class FlTrackedDataHandlerRegistry {
    ...
    public static final Registry<FlTrackedDataHandler<?>> handlerRegistry = FabricRegistryBuilder.createSimple(FL_TRACKED_DATA_HANDLER_REGISTRY_KEY).attribute(RegistryAttribute.SYNCED).buildAndRegister();;
