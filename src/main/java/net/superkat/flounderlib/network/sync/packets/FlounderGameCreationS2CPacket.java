...
public record FlounderGameCreationS2CPacket(int minigameId, IFlounderGame game) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, FlounderGameCreationS2CPacket> CODEC = PacketCodec.of(
            FlounderGameCreationS2CPacket::write, FlounderGameCreationS2CPacket::fromBuf
    );
    ...
    public static FlounderGameCreationS2CPacket fromBuf(RegistryByteBuf buf) {
        ...
        return new FlounderGameCreationS2CPacket(minigameId, game);
    }
    ...
    public void write(RegistryByteBuf buf) {
        ...
        FlounderGameType<?> gameType = FlounderApi.getRegistry().get(gameId);
        if(gameType == null || !gameType.shouldSync()) return;

        PacketCodec<ByteBuf, Object> packetCodec = (PacketCodec<ByteBuf, Object>) gameType.packetCodec();
